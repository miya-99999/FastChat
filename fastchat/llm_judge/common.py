...
def load_questions(question_file: str, begin: Optional[int], end: Optional[int]):
    ...
    questions = []
    with open(question_file, "r", encoding='utf-8') as ques_file: # fix encoding issue
...
def load_model_answers(answer_dir: str):
    ...
    for filename in filenames:
        ...
        answer = {}
        with open(filename, encoding='utf-8') as fin: # fix encoding issue
            for line in fin:
...
def load_judge_prompts(prompt_file: str):
    ...
    """
    prompts = {}
    with open(prompt_file, encoding='utf-8') as fin: # fix encoding issue
        for line in fin:
            line = json.loads(line)
